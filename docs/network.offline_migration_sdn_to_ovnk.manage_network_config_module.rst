.. _network.offline_migration_sdn_to_ovnk.manage_network_config_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>Namespace in which the CNI configuration resides.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>network_provider_config</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                ...
                <td>
                        <div>Name of the network provider config openshiftSDNConfig or ovnKubernetesConfig</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
